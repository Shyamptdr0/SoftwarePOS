-- Comprehensive fix for sales tables and RLS policies
-- This script ensures all tables exist and have proper structure
...
-- Create sales table with simplified RLS
...
-- Create simplified RLS policies that use the default store ID
-- This bypasses the auth.uid() issue for now
...
-- Also fix the createSale function to handle the stock updates properly
